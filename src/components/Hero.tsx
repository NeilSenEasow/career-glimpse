...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
      ...
      <div 
        ref={addToRefs}
        className="blob w-[600px] h-[600px] top-[-200px] right-[-100px] bg-primary/10 animate-blob"
      ></div>
      <div 
        ref={addToRefs}
        className="blob w-[500px] h-[500px] bottom-[-150px] left-[-100px] bg-accent/10 animate-blob animation-delay-2000"
      ></div>
      <div 
        ref={addToRefs}
        className="blob w-[300px] h-[300px] bottom-[100px] right-[300px] bg-foreground/5 animate-blob animation-delay-4000"
      ></div>
      ...
      <div className="container px-6 md:px-8 mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 z-10">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <Link 
              to="/test" 
              className="px-8 py-3.5 rounded-full bg-primary text-white font-medium text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:translate-y-[-2px] active:translate-y-0 transition-all duration-300 button-shine w-full sm:w-auto text-center"
            >
              Start Assessment
            </Link>
            ...
            <a 
              href="#how-it-works" 
              className="px-8 py-3.5 rounded-full border border-border bg-background hover:bg-secondary transition-colors duration-300 font-medium text-lg w-full sm:w-auto text-center"
            >
              Learn More
            </a>
          </div>
